...
const Page = () => {
  ...
  const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    try{
      ...
      console.log("Registration failed:", error instanceof Error ? error.message : error)
    }  
  }
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen gap-8 bg-background py-5'>
        <div className='text-center text-off-white-1'>
          ...
          <p className='text-off-white-2'>Sign up for your account</p>
        </div>
        <div className='w-1/3 min-h-125 border border-slate-700/50 bg-card rounded-lg p-8'>
          <form onSubmit={handleSubmit} className='flex flex-col gap-6'>
            ...
            <div className='flex gap-2'>
                <div className='flex flex-col gap-2 text-sm'>
                    ...
                    <div className=' border border-slate-700/50 rounded-2xl bg-background-2   focus-within:border-primary focus-within:border-2 focus-within:ring-1 focus-within:ring-primary transition duration-300 flex items-center'>
                        <UserPen size={20} className='text-off-white-2 ml-4'/>
                        <input className='w-full h-full p-4   outline-none' name="firstName" 
                        type="text" 
                        id="firstName"  
                        placeholder='Toji' 
                ...
                <div className='flex flex-col gap-2 text-sm'>
                    ...
                    <div className=' border border-slate-700/50 rounded-2xl bg-background-2   focus-within:border-primary focus-within:border-2 focus-within:ring-1 focus-within:ring-primary transition duration-300 flex items-center'>
                        <UserPen size={20} className='text-off-white-2 ml-4'/>
                        <input className='w-full h-full p-4   outline-none' name="lastName" 
                        type="text" 
                        id="lastName"  
            ...
            <div className='flex flex-col gap-2 text-sm'>
              ...
              <div className=' border border-slate-700/50 rounded-2xl bg-background-2   focus-within:border-primary focus-within:border-2 focus-within:ring-1 focus-within:ring-primary transition duration-300  flex items-center'>
                ...
                <input className='w-full h-full p-4  outline-none' type="password" 
                id="password"  
            ...
            <div className='flex justify-end text-primary/90 hover:text-primary/70 transition duration-100 cursor-pointer'>
              <label className='d gap-2 text-sm'>
                
                Forgot password?
              </label>
            </div>
            <button type='submit' className='bg-primary text-white py-3 rounded-2xl hover:bg-primary/90 transition duration-300 shadow-md shadow-primary/30 text-shadow-md text-shadow-white/10'>Sign Up</button>
          </form>
          <div>
          <div className='flex text-xs text-off-white-2/70 items-center justify-center my-6 gap-2'>
            ...
            <div className='flex items-center justify-between gap-4'>
              <div className='flex justify-center items-center font-semibold text-off-white-1 rounded-2xl border border-slate-700/50 bg-background-2 hover:bg-background-3 transition duration-300 cursor-pointer flex-1 py-3'>
