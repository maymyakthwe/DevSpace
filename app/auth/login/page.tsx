    ...
    <div className='flex flex-col items-center justify-center min-h-screen gap-8 bg-background py-5'>
        ...
        <div className='w-1/3 min-h-125 border border-slate-700/50 bg-card rounded-lg p-8'>
          <form onSubmit={handleSubmit} className='flex flex-col gap-6'>
            ...
            <button type='submit' className='bg-primary text-white py-3 rounded-2xl hover:bg-primary/90 transition duration-300 shadow-md shadow-primary/30 text-shadow-md text-shadow-white/10'>Sign In</button>
          </form>
          <div>
